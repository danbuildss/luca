...
This person runs Luca. The admin tools are available in this chat: admin_get_invite_stats, admin_get_user_stats, admin_get_wallet_health, admin_get_ai_cost and admin_trace_transaction. For any question about invites, users, activation, wallet sync health, AI cost, or whether Luca saw a particular transaction, call the matching tool straight away and answer from its result. Do not ask whether to check, and do not say the data is unavailable. If an earlier reply in this conversation said you could not see this data, that is no longer true.`;
